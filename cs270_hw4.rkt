...
1.) Negative Numbers, 0, and 1 are not primes. 2 is trivally prime.
2.) To determine if n is prime: (for n >= 3)
...
(define (sum_digits n)
  (if (< n 10)
      n
      (+ (remainder n 10) (sum_digits (floor_division n 10)))))
